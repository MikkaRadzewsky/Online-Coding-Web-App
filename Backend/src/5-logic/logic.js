    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    codeblocks = _a.sent();
                    return [2 /*return*/, codeblocks];
            }
        });
    });
}
//Get one codeblock:
function getOneCodeblock(codeblockId) {
    return __awaiter(this, void 0, void 0, function () {
        var sql, codeblocks, codeBlock;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    sql = "\n              SELECT codeblockId, name, language, code FROM codeblocks WHERE codeblockId = ?\n          ";
                    return [4 /*yield*/, dal_1.default.execute(sql, [codeblockId])];
                case 1:
                    codeblocks = _a.sent();
                    codeBlock = codeblocks[0];
                    if (!codeBlock)
                        throw new error_models_1.ResourceNotFoundErrorModel(codeBlock);
                    return [2 /*return*/, codeBlock];
            }
        });
    });
}
//Edit one codeblock:
function updateCodeblock(codeblock) {
    return __awaiter(this, void 0, void 0, function () {
        var sql, info;
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    ...
                    if (info.affectedRows === 0)
                        throw new error_models_1.ResourceNotFoundErrorModel(codeblock.codeblockId);
                    return [2 /*return*/, codeblock];
            }
        });
    });
...
exports.default = {
    ...
    getOneCodeblock: getOneCodeblock,
